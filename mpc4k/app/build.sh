#!/bin/zsh
# Builds "MPC 4000 File Manager.app" and installs it into /Applications.
set -euo pipefail
cd "$(dirname "$0")"

APP="/Applications/MPC 4000 File Manager.app"

echo "compiling…"
swiftc -O -parse-as-library Mpc4kApp.swift -o mpc4k-gui

echo "assembling bundle…"
rm -rf "$APP"
mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Resources"
mv mpc4k-gui "$APP/Contents/MacOS/"
